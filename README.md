...
📋 Features
Robust Data Entry: Captures client name, fitness levels, class enrollment, and extra sessions.

Automatic Validation: Ensures fitness levels are valid (Beginner, Intermediate, Advanced) and numeric inputs are within acceptable ranges.

Monthly Cost Calculation: Automatically calculates costs based on a standard 4-week month.

Eligibility Enforcement: Logic restricts Wellness Workshop attendance to only Intermediate and Advanced clients.
